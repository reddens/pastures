...
<html>
    ...
    <table width=100%>
      ...
      <p align='center' class=greet>Student Documents</p>
    <?php
      ...
      if ($result = mysqli_query($conn, $sql)) {
       ...
       if ($result->num_rows > 0) {
        echo "<table class=browse align='center' border=1><tr><th>Username</th><th>File Name</th><th>View File</th></tr>";
         while($row = $result->fetch_assoc()){
          echo "<tr><td>".$row["username"]."</td><td>".$row["filenam"]."</td><td><a href='applications/{$row["username"]}{$row["filenam"]}.pdf'>Download</a></td></tr>";
          }
         } else {
